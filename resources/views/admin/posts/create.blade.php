    ...
    <div class="row justify-content-center">
        <div class="col-12">
            ...
            <form action="{{ route('admin.posts.store') }}" method="post">
                ...
                <div class="form-group">
                    <label>Autore</label>
                    <input type="text" name="author" class="form-control" placeholder="Inserisci l'autore" maxlength="255" required>
                </div>
                <div class="form-group">
                    <label>Contenuto</label>
                    <textarea name="text" class="form-control" rows="20" placeholder="Inizia a scrivere qualcosa..." required></textarea>
                </div>
                <div class="form-group">
                    <label>Data</label>
                    <input type="text" name="date" class="form-control" placeholder="Inserisci la data" maxlength="255" required>
                </div>
                <div class="form-group">
                    <label>Orario</label>
                    <input type="text" name="time" class="form-control" placeholder="Inserisci l'ora" maxlength="255" required>
                </div>
                <div class="form-group">
