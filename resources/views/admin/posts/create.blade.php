        ...
        <div class="col-12">
            ...
            <form action="{{ route('admin.posts.store') }}" method="post">
                ...
                <div class="form-group">
                    <label>Titolo</label>
                    <input type="text" name="title" class="form-control" placeholder="Inserisci il titolo" maxlength="255" value="{{ old('title') }}">
                    @error('title')
                ...
                <div class="form-group">
                    <label>Autore</label>
                    <input type="text" name="author" class="form-control" placeholder="Inserisci l'autore" maxlength="255" value="{{ old('author') }}">
                    @error('author')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
